...
function Menu() {
    ...
    return ( <div className='home'>
      ...
      <section className="allButtons">
        ...
        <button onClick={() => filterCategory("ikea")}>Ikea</button>
        <button onClick={() => filterCategory("marcos")}>Marcos</button>
        <button onClick={() => filterCategory("caressa")}>Caressa</button>
        <button onClick={() => filterCategory("liddy")}>Liddy</button>
      </section>
          ...
          .filter(
            (product) =>
              (selectedCategory === 'all' ||
                selectedCategory === product.company) &&
